...
<header class="header-responsive px2 fixed-top" style="background-color: #385668">
    <div class="flex flex-row items-center">
        ...
        <nav class="ml-auto h-fit flex items-center">
            ...
            <p style="color: antiquewhite" class="inline-block btn-wow mr-2">Halo, {{ auth()->user()->name }}</p>

            <p style="color: antiquewhite" class="inline-block btn-wow">
